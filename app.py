...
.file-preview-bar button:hover { color: #ff6b6b; }
...
.send-btn:hover { transform: scale(1.05); box-shadow: 0 0 20px rgba(124,106,255,0.4); }
...
.new-chat-btn:hover { background: rgba(124,106,255,0.25); }
